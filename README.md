...
Builder stage — installs dependencies into a separate directory using python:3.14-slim
Final stage — copies only the app and deps into a distroless image
Benefits:
